# -*- coding: utf-8 -*-
"""nlp-modelos-linguagem.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1dK5fGXmvewm6T6-rTXoLc3Kw6xmBbZa1

# Carregando dados em português
"""
...
import pandas as pd
uri = "https://raw.githubusercontent.com/alura-cursos/nlp-modelos-linguagem/master/dataset/stackoverflow_portugues.csv"
dados_portugues = pd.read_csv(uri)
dados_portugues.head()

questao_portugues = dados_portugues.Questão[5]
print(questao_portugues)

"""# Carregando dados em inglês"""

uri = "https://raw.githubusercontent.com/alura-cursos/nlp-modelos-linguagem/master/dataset/stackoverflow_ingles.csv"

dados_ingles = pd.read_csv(uri)
dados_ingles.head()

questao_ingles = dados_ingles.Questão[0]
print(questao_ingles)

"""# Carregando dados em espanhol"""

uri = "https://raw.githubusercontent.com/alura-cursos/nlp-modelos-linguagem/master/dataset/stackoverflow_espanhol.csv"

dados_espanhol = pd.read_csv(uri,sep=';',encoding='latin1' )
dados_espanhol.head()
...
"""# Criando modelo e separando treino e teste"""
