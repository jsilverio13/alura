(ns clojure-property-based-test.logic-test
  (:require [clojure-property-based-test.hospital.logic :refer [cabe-na-fila?
                                                                chega-em
                                                                total-de-pacientes
                                                                transfere]]
            [clojure-property-based-test.hospital.model :as h.model]
