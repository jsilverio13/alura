(ns datomic-bindings-transaction-functions-e-filters.ecommerce.db
  (:require [clojure.pprint :refer [pprint]]
            [clojure.walk :as walk]
            [datomic-bindings-transaction-functions-e-filters.ecommerce.model :as model]
            [datomic.api :as d]
            [schema.core :as s]
            [clojure.set :as cset]))
...
(s/defn atualiza-produto! [conn , antigo :- model/Produto, a-atualizar :- model/Produto]
