(ns datomic-identidade-e-queries.ecommerce.aula6
...
(pprint @(db/adiciona-produtos! conn [{:produto/nome "Camiseta"
                                       ...
                                       :produto/categoria {:categoria/nome "Roupas"
                                                           :categoria/id (model/uuid)}}]  "200.216.222.112"))
...
(pprint @(db/adiciona-produtos! conn [{:produto/nome "Dama"
                                       ...
                                       :produto/preco 15M
                                       :produto/id (model/uuid)
                                       :produto/categoria [:categoria/id (:categoria/id esporte)]}] "210.216.222.112"))
...
(pprint (db/todos-os-produtos-do-ip (d/db conn) "200.216.222.112"))
(pprint (db/todos-os-produtos-do-ip (d/db conn) "210.216.222.112"))
