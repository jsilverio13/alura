...
void main() {
  ...
  testWidgets('Integration Test', (tester) async {
    ...
    expect(Provider.of<Types>(providerKey.currentContext!, listen: false).types.last.icon,
        Icons.card_giftcard);
    ...
    await tester.enterText(find.byKey(const Key('EmailKey1')), 'dandara@bot.com.br');
