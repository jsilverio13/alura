            ...
            itemBuilder: (context, index) {
              return Dismissible(
                ...
                child: ListTile(
                  ...
                  title:
                      Text(list.clients[index].name + ' (' + list.clients[index].type.name + ')'),
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          actions: [
            Consumer<Clients>(builder: (BuildContext context, Clients list, Widget? widget) {
              return TextButton(
