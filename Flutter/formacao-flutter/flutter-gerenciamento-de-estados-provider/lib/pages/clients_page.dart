...
class _ClientsPageState extends State<ClientsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<Clients>(builder: (BuildContext context, Clients list, Widget? widget) {
          ...
          itemBuilder: (context, index) {
            return Dismissible(
              ...
              onDismissed: (direction) {
                setState(() {
                  list.remove(list.clients[index]);
                });
              },
            );
          },
                ...
                builder: (BuildContext context, Clients list, Widget? widget) {
                  return TextButton(
                      ...
                      onPressed: () async {
                        setState(() {
                          list.add(Client(
                              name: nomeInput.text, email: emailInput.text, type: dropdownValue));
                        });
